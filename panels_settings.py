"""Settings panel for FullStory Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__fullstory_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=fullstory_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_fullstory"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("FullStory Settings & Accounts", level=2),
